...
class PrincipalScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double attendancePercent = studentAttendance.isEmpty
        ? 0
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      Text(
                        '$presentCount / ${studentAttendance.length} Present',
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    subtitle: Text(
                      'Quantity: ${item['quantity']} • Ordered: ${item['date']}',
                    ),
                  );
                },
              ),
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    subtitle: Text(
                      'Received: ${item['quantity']} • ${item['date']}',
                    ),
                    trailing: Chip(
                      label: Text(
                        item['status']!,
