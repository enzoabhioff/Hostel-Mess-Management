...
class WardenScreen extends StatelessWidget {
  ...
  // Sample student attendance data for the hostel
  final List<Map<String, dynamic>> studentAttendance = const [
    {'name': 'NANDITHA', 'room': '101', 'present': true},
    {'name': 'TEENA', 'room': '101', 'present': true},
    {'name': 'ANIKA', 'room': '101', 'present': false},
    {'name': 'NAZRIN', 'room': '101', 'present': true},
    {'name': 'HARSHA', 'room': '102', 'present': true},
    {'name': 'NASHVA', 'room': '102', 'present': true},
    {'name': 'SONA', 'room': '102', 'present': false},
    {'name': 'ASHMIDA', 'room': '103', 'present': true},
    {'name': 'SOJA', 'room': '103', 'present': true},
    {'name': 'ADITHYA', 'room': '103', 'present': true},
    {'name': 'GOPIKA', 'room': '104', 'present': false},
    {'name': 'ADITHI', 'room': '104', 'present': true},
    {'name': 'MALAVIKA', 'room': '105', 'present': true},
    {'name': 'ANEESHYA', 'room': '105', 'present': true},
    {'name': 'GANGA', 'room': '105', 'present': false},
  ];
            ...
            Container(
              ...
              child: const Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(
                    'Monitor hostel attendance and mess operations',
            ...
            _buildViewCard(
              ...
              child: Column(
                children: [
                  ...
                  const Text('Student Attendance List',
                  ...
                  return ListTile(
                    ...
                    trailing: Chip(
                      label: Text(item['status']!,
                          style: TextStyle(
                              color: isShort ? Colors.red : Colors.green, fontSize: 12)),
